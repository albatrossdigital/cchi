<!-- /page-background-inner<div id="page-background"><div id="page-background-inner"></div></div>  /page-background -->
<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div id="main"<?php if ($page['highlight']) { print ' class="has-highlight"'; } ?>>
