        ...
        editor.widgets.add( 'widgetfoundationLeftCol', {
            ...
            template:
                '<div class="row two-col-left">' +
                    '<div class="columns small-12 medium-3 col-sidebar"><img src="http://placehold.it/300x250&text=300x250" /></div>' +
        ...
        editor.widgets.add( 'widgetfoundationTwoCol', {
            ...
            template:
                '<div class="row two-col">' +
                    '<div class="columns small-12 medium-6 col-1"><img src="http://placehold.it/400x250&text=400x250" /><p>Content</p></div>' +
                    '<div class="columns small-12 medium-6 col-2"><img src="http://placehold.it/400x250&text=400x250" /><p>Content</p></div>' +
                '</div>',
        ...
        editor.widgets.add( 'widgetfoundationThreeCol', {
            ...
            template:
                '<div class="row three-col">' +
                    '<div class="columns small-12 medium-4 col-1"><img src="http://placehold.it/300x200&text=300x200" /><p>Text below</p></div>' +
                    '<div class="columns small-12 medium-4 col-2"><img src="http://placehold.it/300x200&text=300x200" /><p>Text below</p></div>' +
                    '<div class="columns small-12 medium-4 col-3"><img src="http://placehold.it/300x200&text=300x200" /><p>Text below</p></div>' +
                '</div>',
